...
//        if (App.showGuestBuildings == "true") {
//            App.buildingRequestType.Type = "all";
//            $("#guest-location-switch").attr("checked", "checked");
//        } else {
//            App.buildingRequestType.Type = "assigned";
//            $("#guest-location-switch").attr("checked", "unchecked");
//        }
